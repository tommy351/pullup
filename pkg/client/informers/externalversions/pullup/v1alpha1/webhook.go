	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PullupV1alpha1().Webhooks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PullupV1alpha1().Webhooks(namespace).Watch(context.TODO(), options)
			},
		},
		&pullupv1alpha1.Webhook{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *webhookInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pullupv1alpha1.Webhook{}, f.defaultInformer)
}
