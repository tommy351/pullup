...
The easiest way to install Pullup CRDS and components is to use the pre-generated YAML files.
...
The YAML file is generated with [kustomize](https://github.com/kubernetes-sigs/kustomize). You can see source files in [deployment](https://github.com/tommy351/pullup/tree/master/deployment) folder. It contains:
